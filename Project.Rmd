...
A little background on cardiomyopathy
...
After filtering `r nrow(Annovar_vcf)` SNP's remained which where sorted, after which the 12 SNP's with the highest score were selected. These 12 SNP are shown below.
...
# Keep all rows that are potentionally damaging
NA_Filtered = NA_Filtered[NA_Filtered$LJB2_SIFT <= 0.05,]

# Sort the genes based on there scoring,
Sorted = NA_Filtered[with(NA_Filtered, order(LJB2_SIFT,
                                             X1000g2015aug_EUR,
